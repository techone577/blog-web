package com.blogging.blogweb.support.spring;

import com.blogging.blogweb.model.constant.BspSubscribeService;
import com.blogging.blogweb.model.constant.PropertiesHolder;
import com.blogging.blogweb.model.constant.RestMethod;
import com.blogging.blogweb.model.eureka.RegistryInfo;
import com.blogging.blogweb.model.eureka.ServiceConfig;
import com.blogging.blogweb.service.FactoryListHolder;
import com.blogging.blogweb.support.annotation.ServiceInfo;
...
public class ApplicationContextCache implements ApplicationContextAware {
    ...
    private void buildRegistryInfo (List<ServiceConfig> list){
